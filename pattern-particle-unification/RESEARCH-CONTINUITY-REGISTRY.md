...
|---|---|---|---|---|
| REG-UMP013-001 | A new abelian anyon system's phase = e^{2πi p/q}, q prime (ramified branch valuation) | Phase outside roots of unity | Interferometry publication, ≥3 independent groups | 2029-12-31 | **Status: first data in hand (2026-08-20)** — moiré FQAH systems ν=2/3, 3/5, 1/3, 1/2 (Cai 2023, Zeng 2023, Park 2023, Lu 2024) characterized; paper §5.4 applies the pre-registered scheme |
...
- 2026-08-20 (v0.5): improvement audit executed (improvement-audit-v05.md) — 23 new references (12 external: ASW 1984, Jain 1989, Leinaas-Myrheim 1977, Wilczek 1982, Halperin 1984, Kitaev 2003, Nayak 2008, FRS 1989, Cai 2023, Zeng 2023, Park 2023, Lu 2024; 11 internal: Langlands, tree dynamics x2, Planckian, SC quadrangle, operationalizing-anyons, zbw-p5, BT-readout, adelic-core, consilience-numtheory, beyond-qubit); new §5.4 "First tests: moiré fractional Chern insulators" applies the pre-registered address scheme to the 2023-2025 FQAH experiments (REG-UMP013-001: first data in hand); §3 tree-dynamics + adelic foundations; §4.1 FRS plekton lineage; §5.1 Majorana (zbw-p5); §7 Planckian/SC-quadrangle scope boundary; §8 Langlands; §10.3 Kitaev/Nayak; §10 classifier moiré dictionary.
