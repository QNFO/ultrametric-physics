...
**ERRATA version:** v1.0
**Date:** 2026-08-10
**STATUS:** PUBLISHED — corrected in v0.7 (DOI 10.5281/zenodo.21880104, canonical, KIF-30 PDF+HTML included). Version chain: v0.4 (21827737) → v0.5 (21878856, metadata update) → v0.6 (21879110, corrected body, self-DOI stale) → v0.6.1 (21879117, self-DOI fixed) → v0.7 (21880104, md+html+pdf, canonical). The deposit-API v0.6 (21879021, detached concept) is superseded.
